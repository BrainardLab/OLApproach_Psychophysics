...
session = MeLMSens_Pulse.dataManagement.loadSessionAcquisitionsFromName(participant, sessionName);
resultsTable = MeLMSens_Pulse.analyze.getSessionResults(session);
end