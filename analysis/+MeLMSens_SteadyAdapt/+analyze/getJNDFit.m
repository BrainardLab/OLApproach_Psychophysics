function JNDNominal = getJNDFit(acquisition)
...
%    2019.03.06  jv   adapted for MeLMSens_SteadyAdapt, fitted threshold

% Get nominal direction at threshold
thresholdDirection = MeLMSens_SteadyAdapt.analyze.getThresholdFitDirection(acquisition);
