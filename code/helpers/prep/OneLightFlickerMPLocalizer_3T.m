...
for i = 1:length(observerAgeInYrs)
    theCalType = 'BoxCLongCableBEyePieceStubby1';
    OLReceptorIsolateMakeModulationStartsStops('Modulation-LMinusMDirected-9sFrequencyModulation2Hz.cfg', observerAgeInYrs(i), theCalType, []) % Light flux at 0, 8, 10, 12, 16, 20, 25 Hz
    OLReceptorIsolateMakeModulationStartsStops('Modulation-LightFlux-9sFrequencyModulation32Hz.cfg', observerAgeInYrs(i), theCalType, []) % Light flux at 0, 8.5, 10.5, 12.5, 17, 21, 25 Hz
    OLReceptorIsolateMakeModulationStartsStops('Modulation-Background-9sFrequencyModulation0Hz.cfg', observerAgeInYrs(i), theCalType, []) % Light flux at 0, 9, 11, 13, 18, 22, 26 Hz
end