...
OLReceptorIsolateMakeModulationStartsStops('Modulation-MelanopsinDirectedLegacyNulled-12sWindowedFrequencyModulation.cfg', o, theCalType, nullingID); % Nulled
OLReceptorIsolateMakeModulationStartsStops('Modulation-LMSDirectedNulled-12sWindowedFrequencyModulation.cfg', o, theCalType, nullingID) % Nulled
