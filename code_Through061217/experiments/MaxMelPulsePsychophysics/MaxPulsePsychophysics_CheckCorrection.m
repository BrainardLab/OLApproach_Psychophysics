%% MaxPulsePsychophysics_CheckCorrection
%
...
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '021417',  'Cache-MelanopsinDirectedSuperMaxMel_HERO_Lambda08_UseAverage_021317.mat'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '021417',  'Cache-LMSDirectedSuperMaxLMS_HERO_Lambda08_UseAverage_021317.mat'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '022217',  'Cache-MelanopsinDirectedSuperMaxMel_HERO_testFullRun_022217.mat'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '022217',  'Cache-LMSDirectedSuperMaxLMS_HERO_testFullRun_022217.mat'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '031517',  'Cache-MelanopsinDirectedSuperMaxMel_HERO_test_031517.mat'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '031517',  'Cache-LMSDirectedSuperMaxLMS_HERO_test_031517.mat'));

%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '032217',  'Cache-MelanopsinDirectedSuperMaxMel_HERO_test_032217.mat'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '032217',  'Cache-LMSDirectedSuperMaxLMS_HERO_test_032217.mat'));

%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '033017',  'Cache-MelanopsinDirectedSuperMaxMel_HERO_300_percent_033017.mat'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '033017',  'Cache-MelanopsinDirectedSuperMaxMel_HERO_400_percent_033017.mat'));

%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '033017',  'Cache-LMSDirectedSuperMaxLMS_HERO_300_percent_033017.mat'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '033017',  'Cache-LMSDirectedSuperMaxLMS_HERO_400_percent_033017.mat'));

%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '041217',  'Cache-LMSDirectedSuperMaxLMS_HERO_400_percent_041217'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '041217',  'Cache-MelanopsinDirectedSuperMaxMel_HERO_400_percent_041217.mat'));

%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '042517',  'Cache-LMSDirectedSuperMaxLMS_HERO_test_400Percent_042517.mat'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '042517',  'Cache-MelanopsinDirectedSuperMaxMel_HERO_test_400Percent_042517.mat'));

%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '042717',  'Cache-LMSDirectedSuperMaxLMS_HERO_test_400Percent_042717.mat'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '042717',  'Cache-MelanopsinDirectedSuperMaxMel_HERO_test_400Percent_042717.mat'));

%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '050217',  'Cache-MelanopsinDirectedSuperMaxMel_HERO_test_400Percent_050217.mat'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '050217',  'Cache-LMSDirectedSuperMaxLMS_HERO_test_400Percent_050217.mat'));

%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '050817',  'Cache-MelanopsinDirectedSuperMaxMel_HERO_400_Pecent_050817.mat'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '050817',  'Cache-LMSDirectedSuperMaxLMS_HERO_400_Pecent_050817.mat'));

%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '052617',  'Cache-LMSDirectedSuperMaxLMS_HERO_NewWay_052617.mat'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '052617',  'Cache-MelanopsinDirectedSuperMaxMel_HERO_NewWay_052617.mat'));

%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '052617',  'Cache-LMSDirectedSuperMaxLMS_HERO_OldWay_052617.mat'));
%load(fullfile(cachePath, 'MaxMelPulsePsychophysics', '052617',  'Cache-MelanopsinDirectedSuperMaxMel_HERO_OldWay_052617.mat'));
