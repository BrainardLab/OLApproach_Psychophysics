...
%% Low Mel
acquisitions(1) = MeLMSens_SteadyAdapt.Acquisition_FlickerSensitivity_2IFC(...
    directions('Mel_low'),...
...
%% High Mel
acquisitions(2) = MeLMSens_SteadyAdapt.Acquisition_FlickerSensitivity_2IFC(...
    directions('Mel_high'),...
...
%% Low LMS
acquisitions(3) = MeLMSens_SteadyAdapt.Acquisition_FlickerSensitivity_2IFC(...
    directions('LMS_low'),...
...
%% High LMS
acquisitions(4) = MeLMSens_SteadyAdapt.Acquisition_FlickerSensitivity_2IFC(...
    directions('LMS_high'),...
