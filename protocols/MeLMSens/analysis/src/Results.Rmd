...
Median nominal JND was higher on the high LMS background than on the low background for each participant (DHB, GKA and JXV; by a factor of 4.70, 4.39 and 2.78 respectively). The JNDs calculated from the measured stimulus change the scaling factors (3.90, 4.55 and 2.55, respectively), but not the overall pattern that JNDs are higher on the high background than on the low background. Weber's law would predict that JNDs would increase by a factor of 4.5; for the nominal JNDs, this seems to hold roughly true for 2 of 3 participants.

On the high melanopic background, median nominal JND was higher than on the low melanopic background for 2 of 3 observers (1.63, 0.88 and 1.14, respectively). These factors indicate a smaller difference than for the LMS-directed backgrounds. The JNDs calculated from the measured stimulus change the scaling factors (1.38, 0.72 and 1.06, respectively), but not the overall pattern that JNDs are slightly higher. 
