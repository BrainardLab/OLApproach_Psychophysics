function barStack = plotBarStackGroups(stackData, groupLabels)
...
%%
%% Edited 2018 Joris Vincent (joris.vincent@pennmedicine.upenn.edu
...
for i=1:NumStacksPerGroup
    ...
    barStack(i,:) = bar(Y, 'stacked');
    set(barStack(i,:),'BarWidth',groupOffset);
    set(barStack(i,:),'XData',groupDrawPos);
end
